...
public class SpecificationServiceImpl implements SpecificationService {
	...
	public void update(Specification specification){
		//根据id查询出一个实体，然后根据id删除实体类再通过循环规格列表插入新添加的
		specificationMapper.updateByPrimaryKey(specification.getSpecification());//因为这个对象里含有id故不用获取id
	...
	public Specification findOne(Long id){
		//根据Id获取一个实体对象，再用条件查询来查出规格选项列表得到结果，
		// 然后调用组合实体类封装结果返回前端
