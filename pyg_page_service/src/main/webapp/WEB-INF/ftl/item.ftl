						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size>0)>
									...
									<img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="500px" height="500px"/>
							...
							<div class="items">
								<ul>
									<#list imageList as image>
									    <li><img src="${image.url}" bimg="${image.url}" onmousemove="preview(this)"  width="500px" height="400px"/></li>
									</#list>
								</ul>
							</div>
							<a class="next">&gt;</a>
							...
							<#list specList as spec>
                                <dl>
									...
									<#list spec.attributeValue as value>
                                        ...
                                        <dd><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}" ng-click="selectSpec('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
